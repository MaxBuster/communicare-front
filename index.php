...
<div class="w3-top">
  <ul class="w3-navbar w3-center w3-padding" id="menu-bar">
    ...
    <li class="w3-left" style="width:25% !important"><a href="./"><font color=#f6eceb>HOME</font></a></li>
    <li class="w3-left" style="width:25% !important"><a href="./mapviz.html"><font color=#f6eceb>MAP</font></a></li>

    <script>
      if (logged_in()) {
        document.getElementById("menu-bar").innerHTML += '<li class="w3-left" style="width:25% !important"><a href="./new-tent.html"><font color=#f6eceb>NEW LOCATION</font></a></li>';
        document.getElementById("menu-bar").innerHTML += '<li class="w3-left" style="width:25% !important"><a onclick="log_user_out();"><font color=#f6eceb>LOGOUT</font></a></li>';
      } else {
        document.getElementById("menu-bar").innerHTML += '<li class="w3-left" style="width:25% !important"><a href="./register.html"><font color=#f6eceb>REGISTER</font></a></li>';
        document.getElementById("menu-bar").innerHTML += '<li class="w3-left" style="width:25% !important"><a href="./login.html"><font color=#f6eceb>SIGN IN</font></a></li>';
      }
    </script>
  </ul>
</div>
...
<header class="bgimg w3-display-container " id="home">
  ...
  <font color=#c64547>ARCHHACKS 2016</font>
...
<div class="w3-container" id="menu">
  <div class="w3-content" style="max-width:700px">
    ...
    <h5 class="w3-center w3-padding-30"><span class="w3-tag w3-wide w3-padding-left w3-padding-right"></span></h5>
...
<footer class="w3-center  w3-padding-48 w3-large">
  <p><font color=#c64547><font size="2">POWERED BY HACKERS!</font></font></p>
</footer>
